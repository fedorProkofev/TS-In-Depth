...
import { Books, BookProperties, BookOrUndefined } from "./types";
...
export const logFirstAvailable = (books: Books): void => {
...
export const сheckoutBooks = (customer: string, ...booksIDs: number[]) => {
